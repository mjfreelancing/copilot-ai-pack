...
This file covers the MaterialDesignInXamlToolkit (MDIX) theming setup for WPF applications. It exists because runtime theme switching in MDIX has sharp edges — wrong brush keys, deprecated APIs, and misleading documentation patterns waste hours.
